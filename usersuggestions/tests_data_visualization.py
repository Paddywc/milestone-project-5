...
class TestDataVisualization(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for i in range(15):
            suggestion = Suggestion(is_feature=True, user=user_1, title="For populating chart",
        ...
        for i in range(30):
            ...
            coin_history_entry = UserCoinHistory(user=user_1, coins_change=(0 - random_coin_transaction),
    ...
    def test_can_get_features_and_bugs_completed_each_day_in_june(self):
        ...
        for suggestion_admin_page in SuggestionAdminPage.objects.all():
            ...
            self.assertTrue(
                (bugs_completed[day_of_june_completed - 1] > 0) or (features_completed[day_of_june_completed - 1] > 0))
