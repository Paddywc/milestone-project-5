...
from .voting import add_suggestion_upvote_to_database, add_comment_upvote_to_database,  declare_winner_if_voting_end_date
...
def render_suggestion_admin_page(request,id):
    """
    """
    print(declare_winner_if_voting_end_date())
