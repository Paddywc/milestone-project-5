...
from .views import create_user, create_referred_user, login_user
class TestViews(TestCase):
    ...
    def test_can_signup_using_signup_page(self):
        ...
        """
        form_data = {"username": "signuptester", "email": "signuptester@email.com", "password1": "123abc...", "password2": "123abc..." }
    ...
    def test_creating_referred_user_adds_extra_coins(self):
        ...
        if settings.COINS_ENABLED:
            ...
            non_referred_user_data = {"username": "noreferral", "email": "noreferral@email.com", "password1": "123abc...", "password2": "123abc..." }
            self.client.post(reverse("signup"), non_referred_user_data, follow=True)
            
            referred_user_data = {"username": "referral", "email": "referral@email.com", "password1": "123abc...", "password2": "123abc..." }
            self.client.post(reverse("referred_signup", kwargs={"ref_user_id": random_existing_user.id}), referred_user_data, follow=True)
